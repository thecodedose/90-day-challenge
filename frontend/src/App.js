...
const LandingPage = () => {
  ...
  const handleLogin = () => {
    const authUrl =
      process.env.REACT_APP_AUTH_URL || "https://auth.emergentagent.com"
      ...
      <div className='container mx-auto px-6 py-12'>
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-gray-200 mb-8 max-w-3xl mx-auto'>
            Build 3 real projects in 90 days. Join web developers worldwide in
            this intensive coding challenge.
          </p>
        </div>
        ...
        <div className='grid md:grid-cols-3 gap-8 mb-16'>
          ...
          <div className='glass-card p-8 text-center hover-lift'>
            ...
            <p className='text-sm text-gray-400 mt-2'>
              Integrate AI/ML into your project
            </p>
          </div>
          ...
          <div className='glass-card p-8 text-center hover-lift'>
            ...
            <p className='text-sm text-gray-400 mt-2'>
              Contribute or build development tools
            </p>
          </div>
        </div>
    ...
    <div className='min-h-screen'>
      ...
      <div className='container mx-auto px-6 py-8'>
        ...
        <div className='grid md:grid-cols-3 gap-6 mb-8'>
          <div className='glass-card p-6 hover-lift'>
            ...
            <p className='text-gray-300 text-sm'>
              {dashboardData?.days_remaining || 90} days remaining
            </p>
        ...
        <div className='grid md:grid-cols-3 gap-6 mb-8'>
          {[1, 2, 3].map((month) => {
            const monthData =
              dashboardData?.month_stats?.[`month_${month}`] || {}
            const monthProjects =
              dashboardData?.projects?.filter((p) => p.month === month) || []
        ...
        <div className='glass-card p-6 mb-8'>
          <div className='flex justify-between items-center mb-4'>
            <h3 className='text-lg font-semibold text-white'>
              Daily Journal - Day {dashboardData?.days_elapsed || 0}
            </h3>
            <div className='flex space-x-2'>
              {!todayJournal && (
                <button
          ...
          {todayJournal ? (
                  ...
                  <span
                    className={`text-xs px-2 py-1 rounded-full ${
                      todayJournal.mood === "happy"
                        ...
                        : todayJournal.mood === "excited"
                        ? "bg-orange-500/20 text-orange-300"
                        : todayJournal.mood === "focused"
                        ? "bg-blue-500/20 text-blue-300"
                        : todayJournal.mood === "tired"
                        ? "bg-gray-500/20 text-gray-300"
                        : todayJournal.mood === "frustrated"
            ...
            <div className='text-center py-8'>
              ...
              <p className='text-gray-500 text-sm'>
                Document your challenge journey, thoughts, and progress
              </p>
            </div>
          )}
        </div>
        ...
        <form onSubmit={handleSubmit} className='space-y-4'>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setFormData({ ...formData, deployed_link: e.target.value })
              }
              className='w-full bg-black/30 border border-white/20 rounded-lg px-3 py-2 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-white/40 focus:border-white/40 backdrop-blur-sm'
            />
          </div>
...
const JournalHeatmap = ({ userId, isPublic = false, onDayClick = null }) => {
  ...
  const getTooltipText = (dayData) => {
    ...
    return `${baseText} - ${moodEmoji[dayData.mood] || "😌"} ${
      dayData.content_length
    } characters${!isPublic ? " (click to edit)" : ""}`
  }
    ...
    <div className='glass-card p-6'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-6'>
        {months.map((month, monthIndex) => {
          ...
          const completedDays = month.days.filter(
            (day) => day.has_entry && !day.is_future
          ).length
          const totalPastDays = month.days.filter(
            (day) => !day.is_future
          ).length
                  ...
                  {weeks.map((week, weekIndex) => (
                    ...
                    >
                      {week.map((day) => (
                        <div
                          key={day.day}
                          className={`heatmap-cell w-4 h-4 rounded border cursor-pointer ${getCellColor(
                            day
                          )}`}
  ...
  return (
    <div className='min-h-screen'>
      ...
      <div className='container mx-auto px-6 py-8'>
            ...
            <div className='flex items-center space-x-3'>
              ...
              <div>
                ...
                <p className='text-xs text-gray-300'>
                  This is how your profile appears to other users. Your journal
                  entries, projects, and activity are publicly visible.
                </p>
              </div>
          ...
          <div className='grid grid-cols-4 gap-4 max-w-lg mx-auto'>
            ...
            <div className='text-center'>
              <div className='text-2xl font-bold text-green-300'>
                {profileData.stats.completed_projects}
              </div>
              <div className='text-sm text-gray-300'>Completed</div>
            </div>
            <div className='text-center'>
              <div className='text-2xl font-bold text-gray-200'>
                Day {profileData.stats.days_elapsed}
              </div>
              <div className='text-sm text-gray-300'>Challenge</div>
            </div>
            <div className='text-center'>
              <div className='text-2xl font-bold text-blue-300'>
                {profileData.stats.journal_entries || 0}
              </div>
        ...
        {profileData.journal_entries &&
          profileData.journal_entries.length > 0 && (
            <div className='glass-card p-6 mb-8'>
              <h3 className='text-lg font-semibold text-white mb-4'>
                Recent Journal Entries
              </h3>
                        ...
                        <div className='mb-3'>
                          ...
                          <div className='flex flex-wrap gap-1'>
                            {project.tech_stack?.map((tech, index) => (
                              <span
                                key={index}
                                className='bg-white/10 text-gray-200 text-xs px-2 py-1 rounded border border-white/20'
                              >
                                {tech}
                              </span>
                            ))}
                ...
                <div className='mt-4 pt-3 border-t border-white/10'>
                  <div className='flex justify-between text-xs text-gray-400'>
                    ...
                    <span>
                      Completed:{" "}
                      {
                        monthProjects.filter((p) => p.status === "completed")
                          .length
                      }
                    </span>
                  </div>
      ...
      <div className='container mx-auto px-6 py-8'>
        <div className='text-center mb-8'>
          ...
          <p className='text-gray-400'>
            Discover what others are building in their 90-day challenge
          </p>
        </div>
        ...
        <div className='sticky-filter rounded-xl p-4 mb-8'>
          <div className='flex flex-col md:flex-row md:items-center md:justify-between gap-4'>
            ...
            <div className='flex items-center space-x-3'>
              ...
              >
                <option value='all'>
                  All Technologies ({projects.length})
                </option>
                {availableTechStacks.map((tech) => {
                  const count = projects.filter(
                    (p) => p.tech_stack && p.tech_stack.includes(tech)
                  ).length
                  return (
          ...
          <div className='text-center py-12'>
            {selectedTechStack === "all" ? (
              <p className='text-gray-400 text-lg'>
                No projects shared yet. Be the first to add one!
              </p>
            ) : (
              <div>
              ...
              >
                <div className='flex items-center space-x-3 mb-4'>
                  ...
                  >
                    ...
                    />
                    <div>
                      <p className='text-white font-medium hover:text-gray-200'>
                        {project.creator_name}
                      </p>
                      <p className='text-gray-400 text-sm'>
                        Month {project.month} • View Profile
                      </p>
                    </div>
                  </button>
                </div>
